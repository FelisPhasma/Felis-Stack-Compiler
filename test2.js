...
var input = `const getMessage = () => "Hello World";[1,2,3].map(n => n + 1);class Example {}`;
...
const options = processOptions({ presets: ['es2015'] });
const code = `const getMessage = () => "Hello World";[1,2,3].map(n => n + 1);class Example {}`;
//console.log(processOptions({ presets: ['es2015'] }));
const B = Babel.transform(code, options);
console.log(B.code);